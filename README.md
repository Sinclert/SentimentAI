...
⚠️ <b>IMPORTANT NOTE:</b> ⚠️ In order to avoid Python to freeze both in macOS and Linux when validating the model, define the environment variable <i>"JOBLIB_START_METHOD"</i> with the value <i>"forkserver"</i>, as it is explained in the <a href="http://scikit-learn.org/stable/faq.html">Scikit-learn FAQ</a>.
...
## Requirements:
This project requires Python >= 3.4 🐍 , as long as some additional packages such as:<br>
